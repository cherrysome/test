const questions = [
  ...
  {
    id: 13,
    text: '당신은 주변 사람들에게 영향력을 미치는 것을 좋아하나요?',
    yes: 'E',
    no: 'I',
  },
  {
    id: 14,
    text: '당신은 솔로 활동보다는 팀 활동을 선호하나요?',
    yes: 'E',
    no: 'I',
  },
  {
    id: 15,
    text: '당신은 사람들 앞에서 발표하는 것을 즐기나요?',
    yes: 'E',
    no: 'I',
  },
  {
    id: 16,
    text: '당신은 항상 계획을 세우고 그 계획을 따르는 편인가요?',
    yes: 'J',
    no: 'P',
  },
  {
    id: 17,
    text: '당신은 일을 미루는 것보다 즉시 처리하는 것을 선호하나요?',
    yes: 'J',
    no: 'P',
  },
  {
    id: 18,
    text: '당신은 일정이 정리되어 있는 것을 좋아하나요?',
    yes: 'J',
    no: 'P',
  },
  {
    id: 19,
    text: '당신은 자신의 감정을 기반으로 결정을 내리는 편인가요?',
    yes: 'F',
    no: 'T',
  },
  {
    id: 20,
    text: '당신은 타인의 감정을 고려하여 행동하는 편인가요?',
    yes: 'F',
    no: 'T',
  },
  {
    id: 21,
    text: '당신은 상황을 이해하는데 있어서 타인의 감정을 중요하게 생각하나요?',
    yes: 'F',
    no: 'T',
  },
  {
    id: 22,
    text: '당신은 추상적인 아이디어나 개념에 흥미가 있나요?',
    yes: 'N',
    no: 'S',
  },
  {
    id: 23,
    text: '당신은 꿈꾸는 것을 좋아하나요?',
    yes: 'N',
    no: 'S',
  },
  {
    id: 24,
    text: '당신은 미래의 가능성을 상상하는 것을 즐기나요?',
    yes: 'N',
    no: 'S',
  },
